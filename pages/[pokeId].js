  ...
  return (
    <>
      <Head>
        ...
        />
        <title>
          Pokedex| {CapitalizeChar(pokeData.Name)} {pokeId}
        </title>
        <meta name="description" content={pokeData.Description} />

        <meta
          property="og:url"
          content={`https://tharunrajeev.github.io/Pokedex/${pokeId}`}
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content={`Pokedex | ${CapitalizeChar(pokeData.Name)} ${pokeId}`}
        />
        <meta property="og:description" content={pokeData.Description} />
        <meta property="og:image" content={spritUrl} />

        <meta name="twitter:card" content="summary_large_image" />
        <meta property="twitter:domain" content="tharunrajeev.github.io/Pokedex" />
        <meta
              ...
              <div className={moduleStyle.MainContainer__detailsContentBox}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <img
                        src={`https://tharunrajeev.github.io/PokedexData/PokemonFootprints/${forifier(
                          pokeId
                        )}.png`}
                        style={{
                          height: "80%",
                ...
                >
                  ...
                  >
                    <img
                      alt="Egg Sprite"
                      style={{ height: "65%" }}
                      src={`https://tharunrajeev.github.io/PokedexData/PokemonEggSprites/${forifier(
                        pokeId
                      )}.png`}
                    ></img>
                  </Box>
